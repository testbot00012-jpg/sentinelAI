...
def generate_expanded_url_dataset():
    ...
    benign_base = [
        ...
        "https://drive.google.com/drive/my-drive", "https://accounts.google.com/b/0/AddSession",
        "https://github.com/torvalds/linux", "https://github.com/features/security",
        "https://gist.github.com/discover", "https://raw.githubusercontent.com/user/repo/main/README.md",
        ...
        "https://login.microsoftonline.com/common/oauth2/authorize", "https://office.com/launch/word",
        "https://amazon.com/dp/B08N5WRWNW", "https://aws.amazon.com/free", "https://amazon.co.uk/deals",
        "https://apple.com/iphone-16-pro", "https://developer.apple.com/documentation/security",
        "https://support.apple.com/en-us/HT201222", "https://icloud.com/find",
        ...
        "https://paypal.com/signin", "https://paypal.com/us/home", "https://paypal.me/business",
        "https://stripe.com/docs/api", "https://stripe.com/payments",
        "https://cloudflare.com/learning/security/what-is-phishing", "https://dash.cloudflare.com",
        ...
        "https://walmart.com/store", "https://bestbuy.com/site", "https://costco.com/warehouse",
        "https://ebay.com/itm/electronic-sensor", "https://irs.gov/individuals",
        "https://usps.com/manage", "https://tools.usps.com/go/TrackConfirmAction",
        "https://fedex.com/tracking", "https://dhl.com/global-en/home/tracking.html", "https://ups.com/track",
        ...
        "https://usa.gov", "https://nih.gov", "https://mit.edu", "https://stanford.edu",
        "https://reuters.com/markets", "https://bloomberg.com/news",
        "https://vercel.com/docs", "https://railway.app/dashboard", "https://render.com/docs"
    ]

    phishing_base = [
        # Raw IP Attacks & Ports
        ...
        "http://51.79.135.212:8443/login-auth/verify",
        "http://185.220.101.5/wells-fargo/account-unlock.php",
        # Brand Subdomain & Authority Masking Attacks
        "http://paypal.com.verify-user-account-security.xyz/login",
        "http://paypal.com-security-verification.net/auth",
        "http://chase.com-secure-online-login.top/auth/index.php",
        "http://chase.com.security-department-update.ml/index",
        "http://appleid.apple.com.manage-account.ga/signin",
        "http://apple.com.id-support-recovery.icu/login",
        "http://appleid.apple.com.verify-device.cam/secure",
        "http://wellsfargo.com.update-security-profile.cf/login.html",
        "http://wellsfargo.com-online-verify.monster/auth",
        "http://netflix.account-billing-update.icu/payment",
        "http://netflix.com-membership-renew.buzz/billing",
        "http://microsoft.secure-auth-login.buzz/verify",
        "http://login.microsoft.com-office365-verify.club/auth",
        "http://amazon.shipping-order-confirm.vip/tracking",
        "http://amazon.com-unusual-charge-alert.fit/signin",
        "http://google.account-security-alert.tk/recover",
        "http://accounts.google.com-support-ticket.xyz/recovery",
        "http://google.com.free-prize-gift-cards.top/claim",
        ...
        "http://binance.com-anti-phishing-code.buzz/auth",
        "http://coinbase.wallet-verify-funds.buzz/restore",
        "http://coinbase.com-kyc-compliance.top/verify",
        "http://metamask.wallet-seed-recovery.icu/phrase",
        "http://metamask.io-connect-sync.cfd/dapp",
        "http://trustwallet.auth-connect-node.click/import",
        "http://trustwallet.com-recovery-key.sbs/backup",
        "http://steam.trade-giftcard-offer.club/accept",
        "http://steamcommunity.com-trade-offer.top/confirm",
        "http://roblox.free-robux-promo.vip/redeem",
        "http://ebay.com-account-resolution.rest/signin",
        "http://walmart.rewards-winner-claim.vip/cards",
        "http://target.giftcard-balance-update.work/auth",
        # Free Cloud Hosting Phishing Kits (pages.dev, web.app, etc.)
        "https://paypal-security-verification.pages.dev/auth",
        "https://chase-bank-alert.web.app/login",
        "https://apple-id-suspended.firebaseapp.com/restore",
        "https://secure-login-recovery.vercel.app/portal",
        "https://netflix-billing-renew.netlify.app/pay",
        "https://metamask-node-sync.duckdns.org/connect",
        "http://bank-of-america-verify.000webhostapp.com/signin",
        "https://wallet-connect-dapp.surge.sh/import",
        "https://irs-refund-claim.glitch.me/form",
        "https://usps-tracking-parcel.b-cdn.net/fee",
        "https://telegram-premium-airdrop.pages.dev/claim",
        "https://discord-nitro-gift.web.app/redeem",
        ...
        "http://xn--amazn-r4a.com/deals/claim",
        # Abused TLD Attacks with Phishing Kits
        ...
        "http://usps-post-redelivery.live/tracking",
        "http://ups-shipment-delay.bond/clearance",
        ...
        # Shorteners with Malicious Targets
        ...
        "https://t.co/MaliciousBankRedirect99",
        # Credential Obfuscation, Document Phishing & Harvesting
        ...
        "http://sharepoint.document-access-verification.xyz/docs",
        ...
        # Typosquatting
        "http://arnazon-prime-order.com/verify",
        "http://paypa1-account-locked.com/signin",
        "http://goog1e-drive-download.com/docs",
        "http://app1e-support-icloud.com/manage",
        "http://micros0ft-online-365.com/login",
        # Synthetic Lures
        "http://supersecure1000.xyz/login",
        "http://winprize2026.top/claim",
        "http://luckybonus99.buzz/reward",
        "http://verifyaccount99.xyz/confirm"
    ]
